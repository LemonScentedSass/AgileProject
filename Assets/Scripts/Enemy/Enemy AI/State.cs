...
public class Idle : State
{
      ...
      public override void Enter()
      {
            ...
            anim.SetFloat("velocity", 0f);                                                                      //Debug.Log("IDLING");
...
public class Pursue : State
{
      ...
      {
            player = GameObject.FindGameObjectWithTag("Player").transform;
            anim.SetFloat("velocity", 2f);                                                                  // Upon entering the Pursue State, trigger the Running animation
...
public class Attack : State
{
      ...
      public override void Enter()
      {
            ...
            anim.SetFloat("velocity", 0f);                                                                // When entering the attack state, play attack animation
      ...
      public override void Exit()
      {
            anim.SetBool("isAttacking", false);                                                               // Upon exiting the Attack State, reset the animation trigger for the attack
                                                                                                              //attackAudio.Stop();
            base.Exit();
      }
