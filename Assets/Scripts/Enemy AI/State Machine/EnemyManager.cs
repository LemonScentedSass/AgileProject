...
{
      [SerializeField] public GameManager.PlayerManager currentTarget; // Assigned automatically by each state script, do not change from inspector for game use but would be good for testing.
